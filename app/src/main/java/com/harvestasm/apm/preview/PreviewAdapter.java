...
class PreviewAdapter extends ArrayAdapter<ChartItem> {
    private final PreviewViewModel viewMultiChartModel;

    public PreviewAdapter(Context context, List<ChartItem> objects, PreviewViewModel viewMultiChartModel) {
