...
class DashboardAdapter extends ArrayAdapter<ChartItem> {
    private final DashboardViewModel viewMultiChartModel;

    public DashboardAdapter(Context context, List<ChartItem> objects, DashboardViewModel viewMultiChartModel) {
