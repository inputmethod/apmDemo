...
abstract public class AddAbstractBarChartFragment extends AddCharDataFragment {
    @BindView(R.id.title)
    TextView titleView;
    ...
    @Override
    protected final void initChart() {
...
//    }
    ...
    protected void initNormalChart() {
...
//        mChart.setMarker(mv); // Set the marker to the chart
    ...
    protected void initStackedChart() {
        mChart.setOnChartValueSelectedListener(this);
